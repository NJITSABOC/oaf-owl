...
public class OWLSelectionFrame implements AbnSelectionFrameFactory {
    ...
    public OWLSelectionFrame() {
        
    }
    
    @Override
    public JInternalFrame createAbNSelectionFrame(
            OAFMainFrame mainFrame) {
        
        JInternalFrame jif = new JInternalFrame();
        jif.setSize(1500, 700);
        
        JPanel jp = new OWLAbNSelectionPanel(new OWLAbNFrameManager(mainFrame, stateFileManager, (frame) -> {
