 ...
 * @author Chris Ochs
 */
public class OWLExpandedRangeAbN extends ExpandedTargetAbN implements OWLAbstractionNetwork {
    
    private final OAFOntologyDataManager dataManager;
    
    public OWLExpandedRangeAbN(ExpandedTargetAbN source, OAFOntologyDataManager dataManager) {
        super(source);
